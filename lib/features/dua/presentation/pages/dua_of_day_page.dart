...
class DuaOfDayPage extends StatelessWidget {
    ...
    return Column(
      children: [
          ...
          child: Row(
            ...
            children: [
              const Column(
                ...
                children: [
                  Text('Dua of the Day', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  Text('Ramadan 2026', style: TextStyle(fontSize: 12, color: AppColors.textSecondary)),
                ],
              ),
              IconButton(
                onPressed: () {
                  context.read<DuaBloc>().add(ToggleBookmarkRequested(dua.id));
                },
                icon: Icon(
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        child: const Text(
                          'DUA OF THE DAY',
                          style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, letterSpacing: 2, color: AppColors.primary),
                        ),
                      ),
                      const SizedBox(height: 24),
                      ...
                      Text(
                        ...
                        style: const TextStyle(fontSize: 32, height: 1.8, color: AppColors.textPrimary),
                      ),
                      const SizedBox(height: 24),
                      ...
                      Row(
                        ...
                        children: [
                          Container(width: 32, height: 1, color: AppColors.primary.withValues(alpha: 0.2)),
                          const SizedBox(width: 8),
                          Icon(Icons.auto_awesome, size: 14, color: AppColors.primary.withValues(alpha: 0.4)),
                          const SizedBox(width: 8),
                          Container(width: 32, height: 1, color: AppColors.primary.withValues(alpha: 0.2)),
                        ],
                      ),
                      ...
                      child: ClayCard(
                        ...
                        child: const Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 8),
                            Text('Copy', style: TextStyle(color: AppColors.textSecondary)),
                          ],
                        ),
                      ),
                    ),
                      ...
                      child: ClayCard(
                        ...
                        child: const Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 8),
                            Text('Share', style: TextStyle(color: AppColors.textSecondary)),
                          ],
                        ),
                      ),
                    ),
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: Colors.white,
            border: Border(top: BorderSide(color: AppColors.primaryLight.withValues(alpha: 0.5))),
          ),
          child: SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              icon: Icon(dua.isRecited ? Icons.check_circle : Icons.check_circle_outline),
              label: Text(dua.isRecited ? 'Recited' : 'Mark as Recited'),
              style: ElevatedButton.styleFrom(
                backgroundColor: dua.isRecited ? AppColors.success : AppColors.primary,
                foregroundColor: dua.isRecited ? const Color(0xFF059669) : AppColors.textPrimary,
              ),
            ),
          ),
        ),

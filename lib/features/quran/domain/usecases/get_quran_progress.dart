...
class GetQuranProgress extends UseCase<QuranProgress, DateTime> {
  final QuranRepository repository;

  GetQuranProgress(this.repository);

  @override
  Future<Either<Failure, QuranProgress>> call(DateTime params) {
    return repository.getQuranProgress(params);
  }
}
